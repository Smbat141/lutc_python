...
popusername = 'recent:smbatpaloyan@gmail.com'
pop_gmail_pass = 'yrjckvmydajfpdnp'  # Google App password
...
smtp_gmail_pass = 'yrjckvmydajfpdnp'  # Google App password
...
myaddress = 'smbatpaloyan@gmail.com'
mysignature = ('Thanks,\n'
...
smtpuser = "smbatpaloyan@gmail.com"  # per your ISP
...
savemailfile = r'savemail.txt'  # not used in PyMailGUI: dialog
...
fetchlimit = 50  # 4E: maximum number headers/emails to fetch on loads
