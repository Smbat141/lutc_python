...
# mailpasswd = mailconfig.getpass('Password for %s?' % mailserver)
mailpasswd = mailconfig.pop_gmail_pass     # MY VERSION
...
server.pass_(mailpasswd)                   # MY VERSION
...
try:
    ...
    for i in range(msgCount):
        ...
        hdr, message, octets = server.top(1, 0)    # octets is byte count
