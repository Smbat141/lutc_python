...
from multiprocessing import Process, Queue  # process-safe shared queue: queue is a pipe + locks/semas
...
if __name__ == '__main__':
    ...
    # must get before join putter
    p.join();
    q.join();
    r.join()
    print('finish', os.getpid(), r.exitcode, q.exitcode, p.exitcode)  # exitcode is child exit status
