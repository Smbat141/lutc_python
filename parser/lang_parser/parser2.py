...
if __name__ == '__main__':
    x = Parser("(12 / 2) / (8 / 4)")  # allow different Parsers
    # x = Parser("8 / 0")
    x = Parser("8 / 4 * 8")
    x.parse()

# # composition pattern in action
# x = PlusNode(NumNode(1),
#          TimesNode(NumNode(3),
...
# x = PlusNode(NumNode(3), TimesNode(NumNode(2), NumNode(4)))
# x.trace(0)
# print(x.apply({}))

# shared_vars = {}
# y = VarNode("a", 0)
# y.assign(5, shared_vars)
# x = PlusNode(y, TimesNode(NumNode(2), NumNode(4)))
# x.trace(0)
# print(x.apply(shared_vars))
