...
from tkinter import *
import time
from custom_tkinter.canvas.canvasDraw import CanvasEventsDemo as CanvasEventsDemoBasic


class CanvasEventsDemo(CanvasEventsDemoBasic):
    def __init__(self, parent=None):
        CanvasEventsDemoBasic.__init__(self, parent)
