...
try:
    from PP4E.Gui.TextEditor import textConfig                        # startup font and colors
...
class TextEditor:                        # mix with menu/toolbar Frame class
    ...
    if __name__ == '__main__':
        from PP4E.Gui.TextEditor.textConfig import (               # my dir is on the path
    ...
    def start(self):                                # run by GuiMaker.__init__
        self.menuBar = [                            # configure menu/toolbar
            ('File', 0,                             # a Gui Maker menu def tree
